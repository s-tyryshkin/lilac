...
```bash
lilac apply remote --host node-1.example.com --port 22 --values values.yaml --values values.node-1.example.com.yaml --script script.sh
lilac apply remote --host node-2.example.com --port 22 --values values.yaml --values values.node-2.example.com.yaml --script script.sh
```
